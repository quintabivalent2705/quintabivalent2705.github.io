...
const zh = {
  ...
  'home.backgroundTitle': '教育、学术访问与工程经历', 'home.backgroundIntro': '博士培养、国际学术访问与汽车动力系统工程经历概览。', 'home.education': '教育经历', 'home.career': '工作经历', 'home.academicVisits': '学术访问与项目', 'home.advisor': '导师', 'home.partners': '查看合作高校与机构 →',
...
const en = {
  ...
  'home.backgroundTitle': 'Education, Academic Visits, and Engineering Experience', 'home.backgroundIntro': 'An overview of doctoral training, international academic visits, and automotive powertrain engineering experience.', 'home.education': 'Education', 'home.career': 'Professional experience', 'home.academicVisits': 'Academic Visits & Programs', 'home.advisor': 'Advisor', 'home.partners': 'View universities and partner institutions →',
...
const vi = {
  ...
  'home.backgroundTitle': 'Học vấn, trao đổi học thuật và kinh nghiệm kỹ thuật', 'home.backgroundIntro': 'Tổng quan quá trình đào tạo tiến sĩ, trao đổi học thuật quốc tế và kinh nghiệm kỹ thuật về hệ thống truyền động ô tô.', 'home.education': 'Học vấn', 'home.career': 'Kinh nghiệm công tác', 'home.academicVisits': 'Trao đổi học thuật và chương trình', 'home.advisor': 'Giảng viên hướng dẫn', 'home.partners': 'Xem các trường và tổ chức hợp tác →',
