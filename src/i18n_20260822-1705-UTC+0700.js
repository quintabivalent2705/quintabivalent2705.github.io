...
const zh = {
  ...
  'page.home': '学术主页', 'page.directions': '研究方向', 'page.projectList': '代表项目', 'page.projectDetail': '项目详情', 'page.outputs': '研究成果', 'page.outputDetail': '成果详情', 'page.kernel': '方法基础', 'page.partners': '合作高校与合作机构',
  ...
  'stats.papers': '已发表论文', 'stats.projects': '研发与工程项目', 'stats.rnd': '研发', 'stats.engineering': '工程', 'stats.abstracts': '已录用摘要', 'stats.patents': '发明专利', 'stats.publicAuthorized': '公开 / 授权', 'stats.software': '已授权软著', 'stats.datasets': '公开数据集',
  'home.researchTitle': '研究领域与方法主线', 'home.researchIntro': '研究包括氢能与燃料电池、新能源汽车动力系统两个应用领域，并以智能测试、虚实验证和工程计算为共性方法。',
  ...
  'home.support': '共性方法支撑两个应用领域', 'home.foundationTitle': '共性方法与技术基座', 'home.foundationSummary': '采用 X-in-the-Loop、工程计算和数据质量分析，将模型、软件、硬件与试验台架纳入同一验证流程。',
  ...
  'directions.title': '研究方向与技术体系', 'directions.intro': '研究分为氢能与燃料电池、新能源汽车动力系统两个应用领域。两个领域共用智能测试、虚实验证、工程计算和数据质量分析方法。',
  'directions.domains': '应用领域', 'directions.appDirs': '应用研究方向', 'directions.foundationCount': '共性技术基座', 'directions.architecture': '应用领域与共性基座', 'directions.domain': '应用领域', 'directions.support': '共性支撑',
  'directions.foundation': '共性方法与技术基座', 'directions.foundationIntro': '用于连接模型、控制器、试验平台和工程数据。', 'directions.methodBase': '方法基座', 'directions.application': '应用研究方向', 'directions.scope': '研究对象与范围', 'directions.methods': '关键方法', 'directions.relatedProjects': '相关项目', 'directions.relatedOutputs': '相关成果', 'directions.view': '查看方向详情 →', 'directions.technologyBase': '技术基座', 'directions.enter': '进入详情 →',
  ...
  'partners.title': '合作高校与合作机构', 'partners.intro': '列出目前正在开展联合培养、访问交流、测试验证或工程合作的高校与机构。', 'partners.universities': '合作高校', 'partners.institutions': '合作机构', 'partners.uniIntro': '涵盖联合培养、访问交流与科研协作。', 'partners.instIntro': '合作内容包括汽车测试、试验装备、工程验证与质量检验。', 'partners.uniUnit': '所', 'partners.instUnit': '家', 'partners.logoAlt': '校徽',
  ...
  'result.method': '所属方法', 'result.directions': '相关研究方向', 'result.info': '成果信息', 'result.type': '成果类型', 'result.status': '成果状态', 'result.date': '关键日期', 'result.role': '本人角色', 'result.projects': '关联项目', 'result.notFound': '成果不存在。', 'result.backList': '返回成果列表',
  'kernel.intro': '该方法用于氢能和新能源汽车相关项目，关联成果与项目见下方列表。', 'kernel.directions': '相关研究方向', 'kernel.outputs': '相关成果', 'kernel.projects': '关联项目', 'kernel.notFound': '研究方法不存在。',
  ...
  'kicker.profile': 'Academic · Research · Engineering', 'kicker.academicProfile': 'ACADEMIC PROFILE', 'kicker.researchFocus': 'Research Focus', 'kicker.commonFoundation': 'COMMON FOUNDATION', 'kicker.selectedWork': 'Selected Work', 'kicker.background': 'Background',
  'kicker.researchDirections': 'RESEARCH DIRECTIONS', 'kicker.researchArchitecture': 'RESEARCH ARCHITECTURE', 'kicker.applicationDirections': 'APPLICATION DIRECTIONS', 'kicker.commonTechnology': 'COMMON TECHNOLOGY',
  'kicker.collaborationNetwork': 'COLLABORATION NETWORK', 'kicker.universities': 'UNIVERSITIES', 'kicker.institutions': 'INSTITUTIONS',
  'kicker.commonResearchMethod': 'Common Research Method', 'kicker.commonTechnologyFoundation': 'Common Technology Foundation', 'kicker.researchDirection': 'Research Direction', 'kicker.engineeringProject': 'Engineering Project', 'kicker.researchProject': 'Research Project', 'kicker.projects': 'Projects', 'kicker.outputs': 'Outputs', 'kicker.output': 'Output'
}
...
const en = {
  ...
  'page.home': 'Academic Homepage', 'page.directions': 'Research Directions', 'page.projectList': 'Selected Projects', 'page.projectDetail': 'Project Details', 'page.outputs': 'Research Outputs', 'page.outputDetail': 'Output Details', 'page.kernel': 'Method Foundation', 'page.partners': 'Universities and Partner Institutions',
  ...
  'stats.papers': 'Published papers', 'stats.projects': 'R&D and engineering projects', 'stats.rnd': 'R&D', 'stats.engineering': 'Engineering', 'stats.abstracts': 'Accepted abstracts', 'stats.patents': 'Invention patents', 'stats.publicAuthorized': 'Published / granted', 'stats.software': 'Registered software', 'stats.datasets': 'Public datasets',
  'home.researchTitle': 'Research Areas and Methodological Mainline', 'home.researchIntro': 'The research spans two application areas—hydrogen and fuel cell systems, and new-energy-vehicle powertrains—supported by common methods in intelligent testing, virtual–physical validation, and engineering computing.',
  ...
  'home.support': 'Common methods support both application areas', 'home.foundationTitle': 'Common Methods and Technology Foundation', 'home.foundationSummary': 'X-in-the-Loop testing, engineering computing, and data-quality analysis integrate models, software, hardware, and test benches into a unified validation workflow.',
  ...
  'directions.title': 'Research Directions and Technical Framework', 'directions.intro': 'The research is organized into two application areas: hydrogen and fuel cell systems, and new-energy-vehicle powertrains. Both are supported by common methods in intelligent testing, virtual–physical validation, engineering computing, and data-quality analysis.',
  'directions.domains': 'Application areas', 'directions.appDirs': 'Application directions', 'directions.foundationCount': 'Common foundations', 'directions.architecture': 'Application Areas and Common Foundation', 'directions.domain': 'APPLICATION AREA', 'directions.support': 'COMMON SUPPORT',
  'directions.foundation': 'Common Methods and Technology Foundation', 'directions.foundationIntro': 'Connecting models, controllers, test platforms, and engineering data.', 'directions.methodBase': 'BASE', 'directions.application': 'Application Research Directions', 'directions.scope': 'Research objects and scope', 'directions.methods': 'Key methods', 'directions.relatedProjects': 'Projects', 'directions.relatedOutputs': 'Outputs', 'directions.view': 'View direction →', 'directions.technologyBase': 'TECHNOLOGY FOUNDATION', 'directions.enter': 'View details →',
  ...
  'partners.title': 'Universities and Partner Institutions', 'partners.intro': 'Current partners for joint training, academic visits, test validation, and engineering collaboration.', 'partners.universities': 'Universities', 'partners.institutions': 'Partner Institutions', 'partners.uniIntro': 'Joint training, academic visits, and research collaboration.', 'partners.instIntro': 'Automotive testing, test equipment, engineering validation, and quality inspection.', 'partners.uniUnit': 'universities', 'partners.instUnit': 'institutions', 'partners.logoAlt': 'logo',
  ...
  'result.method': 'Method', 'result.directions': 'Research Directions', 'result.info': 'Output Information', 'result.type': 'Type', 'result.status': 'Status', 'result.date': 'Date', 'result.role': 'Role', 'result.projects': 'Related Projects', 'result.notFound': 'Output not found.', 'result.backList': 'Return to output list',
  'kernel.intro': 'This method supports projects in hydrogen and new-energy-vehicle systems. Related directions, outputs, and projects are listed below.', 'kernel.directions': 'Research Directions', 'kernel.outputs': 'Related Outputs', 'kernel.projects': 'Related Projects', 'kernel.notFound': 'Research method not found.',
...
const vi = {
  ...
  'page.home': 'Trang học thuật', 'page.directions': 'Hướng nghiên cứu', 'page.projectList': 'Dự án tiêu biểu', 'page.projectDetail': 'Chi tiết dự án', 'page.outputs': 'Kết quả nghiên cứu', 'page.outputDetail': 'Chi tiết kết quả', 'page.kernel': 'Nền tảng phương pháp', 'page.partners': 'Trường đại học và tổ chức hợp tác',
  ...
  'stats.papers': 'Bài báo đã công bố', 'stats.projects': 'Dự án R&D và kỹ thuật', 'stats.rnd': 'R&D', 'stats.engineering': 'Kỹ thuật', 'stats.abstracts': 'Tóm tắt đã được chấp nhận', 'stats.patents': 'Bằng sáng chế', 'stats.publicAuthorized': 'Công bố / cấp bằng', 'stats.software': 'Phần mềm đã đăng ký', 'stats.datasets': 'Bộ dữ liệu công khai',
  ...
  'home.support': 'Các phương pháp chung hỗ trợ cả hai lĩnh vực ứng dụng', 'home.foundationTitle': 'Nền tảng phương pháp và công nghệ dùng chung', 'home.foundationSummary': 'Kiểm thử X-in-the-Loop, tính toán kỹ thuật và phân tích chất lượng dữ liệu tích hợp mô hình, phần mềm, phần cứng và bệ thử trong một quy trình kiểm chứng thống nhất.',
  ...
  'directions.title': 'Hướng nghiên cứu và khung công nghệ', 'directions.intro': 'Hai lĩnh vực ứng dụng chính là hệ thống hydro và pin nhiên liệu, cùng hệ thống truyền động xe năng lượng mới. Cả hai sử dụng chung các phương pháp thử nghiệm thông minh, kiểm chứng kết hợp thực–ảo, tính toán kỹ thuật và phân tích chất lượng dữ liệu.',
  'directions.domains': 'Lĩnh vực ứng dụng', 'directions.appDirs': 'Hướng nghiên cứu ứng dụng', 'directions.foundationCount': 'Nền tảng dùng chung', 'directions.architecture': 'Lĩnh vực ứng dụng và nền tảng dùng chung', 'directions.domain': 'LĨNH VỰC ỨNG DỤNG', 'directions.support': 'HỖ TRỢ DÙNG CHUNG',
  'directions.foundation': 'Nền tảng phương pháp và công nghệ dùng chung', 'directions.foundationIntro': 'Kết nối mô hình, bộ điều khiển, nền tảng thử nghiệm và dữ liệu kỹ thuật.', 'directions.methodBase': 'NỀN TẢNG', 'directions.application': 'Các hướng nghiên cứu ứng dụng', 'directions.scope': 'Đối tượng và phạm vi nghiên cứu', 'directions.methods': 'Phương pháp chính', 'directions.relatedProjects': 'Dự án liên quan', 'directions.relatedOutputs': 'Kết quả liên quan', 'directions.view': 'Xem chi tiết hướng nghiên cứu →', 'directions.technologyBase': 'NỀN TẢNG CÔNG NGHỆ', 'directions.enter': 'Xem chi tiết →',
  ...
  'partners.title': 'Trường đại học và tổ chức hợp tác', 'partners.intro': 'Các đối tác hiện đang phối hợp trong đào tạo, trao đổi học thuật, kiểm chứng thử nghiệm hoặc triển khai kỹ thuật.', 'partners.universities': 'Trường đại học', 'partners.institutions': 'Tổ chức hợp tác', 'partners.uniIntro': 'Đào tạo, trao đổi học thuật và hợp tác nghiên cứu.', 'partners.instIntro': 'Thử nghiệm ô tô, thiết bị thử nghiệm, kiểm chứng kỹ thuật và kiểm định chất lượng.', 'partners.uniUnit': 'trường', 'partners.instUnit': 'tổ chức', 'partners.logoAlt': 'biểu trưng',
  ...
  'result.method': 'Phương pháp', 'result.directions': 'Hướng nghiên cứu', 'result.info': 'Thông tin kết quả', 'result.type': 'Loại hình', 'result.status': 'Trạng thái', 'result.date': 'Thời gian', 'result.role': 'Vai trò', 'result.projects': 'Dự án liên quan', 'result.notFound': 'Không tìm thấy kết quả.', 'result.backList': 'Trở về danh sách kết quả',
  'kernel.intro': 'Phương pháp này được áp dụng cho các dự án về hydro và xe năng lượng mới. Các hướng nghiên cứu, kết quả và dự án liên quan được liệt kê bên dưới.', 'kernel.directions': 'Hướng nghiên cứu', 'kernel.outputs': 'Kết quả liên quan', 'kernel.projects': 'Dự án liên quan', 'kernel.notFound': 'Không tìm thấy phương pháp nghiên cứu.',
  ...
  'kicker.profile': 'HỌC THUẬT · NGHIÊN CỨU · KỸ THUẬT', 'kicker.academicProfile': 'HỒ SƠ HỌC THUẬT', 'kicker.researchFocus': 'TRỌNG TÂM NGHIÊN CỨU', 'kicker.commonFoundation': 'NỀN TẢNG DÙNG CHUNG', 'kicker.selectedWork': 'KẾT QUẢ TIÊU BIỂU', 'kicker.background': 'HỌC VẤN VÀ KINH NGHIỆM',
  'kicker.researchDirections': 'HƯỚNG NGHIÊN CỨU', 'kicker.researchArchitecture': 'CẤU TRÚC NGHIÊN CỨU', 'kicker.applicationDirections': 'HƯỚNG NGHIÊN CỨU ỨNG DỤNG', 'kicker.commonTechnology': 'CÔNG NGHỆ DÙNG CHUNG',
  'kicker.collaborationNetwork': 'MẠNG LƯỚI HỢP TÁC', 'kicker.universities': 'TRƯỜNG ĐẠI HỌC', 'kicker.institutions': 'TỔ CHỨC',
  'kicker.commonResearchMethod': 'Phương pháp nghiên cứu dùng chung', 'kicker.commonTechnologyFoundation': 'Nền tảng công nghệ dùng chung', 'kicker.researchDirection': 'Hướng nghiên cứu', 'kicker.engineeringProject': 'Dự án kỹ thuật', 'kicker.researchProject': 'Dự án nghiên cứu', 'kicker.projects': 'Dự án', 'kicker.outputs': 'Kết quả', 'kicker.output': 'Kết quả'
}
...
export const lKernel = kernel => activeOverlay()?.kernels?.[kernel?.id] ?? kernel?.name ?? ''
